...
public class RemindViewActivity extends BaseActivity implements RemindViewMvpView {

    @Inject
    RemindViewMvpPresenter<RemindViewMvpView> mPresenter;

    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, RemindViewActivity.class);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remind_view);
