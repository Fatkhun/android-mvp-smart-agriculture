...
import com.fatkhun.agriculture.mvp.data.dialogs.AdvancedRepeatSelector;
import com.fatkhun.agriculture.mvp.data.dialogs.DaysOfWeekSelector;
import com.fatkhun.agriculture.mvp.data.dialogs.IconPicker;
import com.fatkhun.agriculture.mvp.data.dialogs.RepeatSelector;
...
import com.fatkhun.agriculture.mvp.utils.AnimationUtil;
...
public class RemindCreateEditActivity extends BaseActivity implements RemindCreateEditMvpView, ColorChooserDialog.ColorCallback,
    ...
    @Inject
    RemindCreateEditMvpPresenter<RemindCreateEditMvpView> mPresenter;

    public static Intent getStartIntent(Context context) {
        Intent intent = new Intent(context, RemindCreateEditActivity.class);
        return intent;
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_remind_create_edit);
    ...
    public void timePicker() {
        TimePickerDialog TimePicker = new TimePickerDialog(RemindCreateEditActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
    ...
    public void datePicker(View view) {
        DatePickerDialog DatePicker = new DatePickerDialog(RemindCreateEditActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
